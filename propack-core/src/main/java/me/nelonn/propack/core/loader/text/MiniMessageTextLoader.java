...
public class MiniMessageTextLoader implements TextLoader {
    public static final MiniMessageTextLoader INSTANCE = new MiniMessageTextLoader();

    private MiniMessageTextLoader() {
    }
