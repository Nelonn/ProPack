...
public final class GsonHelper {
    ...
    public static JsonObject asObject(JsonElement element, String name) {
        if (element.isJsonObject()) {
            ...
            throw new JsonSyntaxException("Expected '" + name + "' to be a object, was " + getType(element));
        }
    }
    ...
    public static JsonObject getObject(JsonObject object, String element) {
        if (object.has(element)) {
            ...
            throw new JsonSyntaxException("Missing '" + element + "', expected to find a object");
        }
    }
    ...
    public static JsonArray asArray(JsonElement element, String name) {
        if (element.isJsonArray()) {
            ...
            throw new JsonSyntaxException("Expected '" + name + "' to be a array, was " + getType(element));
        }
    }
    ...
    public static JsonArray getArray(JsonObject object, String element) {
        if (object.has(element)) {
            ...
            throw new JsonSyntaxException("Missing '" + element + "', expected to find a array");
        }
    }
